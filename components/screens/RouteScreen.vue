...
.route-panel-fixed { position: fixed; top: 0; left: 0; right: 0; z-index: 30; background: #0c0c20; border-bottom: 2px solid rgba(255,255,255,0.06); padding: 20rpx 16rpx 20rpx; transition: transform 0.3s ease-out; }
.route-panel-fixed.panel-hidden { transform: translateY(-100%); }

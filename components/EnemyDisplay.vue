...
<style lang="scss">
.enemy-card { background: linear-gradient(180deg, rgba(40,10,10,0.9), rgba(30,10,20,0.9)); border: 1px solid rgba(231,76,60,0.2); border-radius: 14rpx; padding: 14rpx 16rpx 10rpx; margin-bottom: 16rpx; }
